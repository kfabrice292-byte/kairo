...
class _CVEditScreenState extends State<CVEditScreen> {
  ...
  void initState() {
    ...
    _title = widget.user.lastCvTitle.isNotEmpty
        ? widget.user.lastCvTitle
        : widget.user.professionalTitle;
    _bio = widget.user.lastCvBio.isNotEmpty
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Adaptez votre profil pour ce CV spécifique. Vos modifications ici ne changeront pas votre profil Kaïro public.',
                ...
                child: ElevatedButton.icon(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      CVGenerator.generateAndPrintCV(
                        customUser,
