 ...
 */
const baseEmailTemplate = (content, preheader = 'Message de KAIRO') => `
<!DOCTYPE html>
<html lang="fr">
<head>
  <meta charset="UTF-8">
...
exports.Templates = {
  ...
  `, 'Bienvenue sur KAIRO, complétez votre profil dès aujourd\'hui !'),
    verifyEmail: (name, link) => baseEmailTemplate(`
  ...
  `, 'Action requise : vérifiez votre adresse e-mail KAIRO'),
    applicationSubmitted: (name, opportunityTitle, companyName) => baseEmailTemplate(`
  ...
  `, `Confirmation de candidature pour ${opportunityTitle}`),
    newApplication: (recruiterName, candidateName, opportunityTitle) => baseEmailTemplate(`
  ...
  `, `Nouvelle candidature de ${candidateName} pour ${opportunityTitle}`),
    applicationAccepted: (name, opportunityTitle, companyName) => baseEmailTemplate(`
  ...
  `, `Excellente nouvelle ! Votre candidature chez ${companyName} avance.`),
    applicationRejected: (name, opportunityTitle, companyName) => baseEmailTemplate(`
  ...
  `, `Mise à jour de votre candidature chez ${companyName}`),
    opportunityMatch: (name, opportunityTitle, companyName, score) => baseEmailTemplate(`
